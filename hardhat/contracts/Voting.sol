...
contract Voting {
    ...
    function startElection(
        ...
        require(electionStarted == false, "Election is currently ongiong");
        delete candidates;
        resetAllVoterStatus();
        ...
        for(uint256 i = 0; i < _candidates.length; i++) {
            candidates.push(
                Candidate({
                    id: i, name:_candidates[i], numberOfVotes:0
                })
            );
        }
